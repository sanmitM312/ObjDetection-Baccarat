...
def main():
    ...
    for match in matches:
        if match['template'] == 'ring':
            ...
            # elif match['template'].startswith('left'):
            #     print("vip cords :", (match["position"][0]+match["size"][0],match["position"][1]+match["size"][1]))
            # elif match['template'].startswith('right'):
